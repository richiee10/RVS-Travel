<template>
  <div class="min-h-screen bg-[#f9f9f6] text-gray-800 font-sans overflow-x-hidden">
    <!-- Navbar (copy from tours.vue for consistency) -->
    ...
    <section class="flex flex-col md:flex-row items-center justify-between px-8 py-10 gap-12">
      <div class="w-full md:w-1/2 animate-fade-in">
        ...
        <ul class="list-disc pl-6 text-gray-700 space-y-2">
          <li><span class="font-semibold text-[#063C1E]">Day 1:</span> Singapore city tour (Marina Bay Sands, Merlion Park, Orchard Road)</li>
          <li><span class="font-semibold text-[#063C1E]">Day 2:</span> Sentosa Island adventure (Universal Studios, S.E.A. Aquarium)</li>
          <li><span class="font-semibold text-[#063C1E]">Day 3:</span> Cultural exploration (Chinatown, Little India, Kampong Glam)</li>
          <li><span class="font-semibold text-[#063C1E]">Day 4:</span> Gardens by the Bay and Cloud Forest</li>
        </ul>
      </div>
      <div class="w-full md:w-1/2 flex justify-center">
        <img src="/images/sg1.jpg" class="rounded-lg shadow-lg max-h-96 object-cover" />
      </div>
    </section>

    <!-- Footer (copy from tours.vue) -->
